...
// CONCATENATED MODULE: ./node_modules/_vue-loader@15.9.6@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_vue-loader@15.9.6@vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=e03a2a58&
...
// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=e03a2a58&
  ...
  methods: {
    async onSubmit() {
      try {
        ...
        console.log("==data", data); // 登录成功，将用户信息存入容器

        this.$store.commit('setUser', data.user); // 将登录状态持久化到 Cookie 中
